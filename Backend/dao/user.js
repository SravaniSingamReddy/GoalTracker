...
async function createUser({ name,age,email,password,mobile,gdo,role}) {
  console.log("============================");
  console.log(name,age,email,password,mobile,gdo,role);
  console.log("============================");  
  return Users.create({
    name,age,email,password,mobile,gdo,role
  });
}
